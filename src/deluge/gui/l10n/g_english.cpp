...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_PARAM_LOCAL_ENV_2_ATTACK, "Env2 attack"},
        {STRING_FOR_PARAM_LOCAL_ENV_2_DECAY, "Env2 decay"},
        {STRING_FOR_PARAM_LOCAL_ENV_2_SUSTAIN, "Env2 sustain"},
        {STRING_FOR_PARAM_LOCAL_ENV_2_RELEASE, "Env2 release"},
        {STRING_FOR_PARAM_LOCAL_ENV_3_ATTACK, "Env2 attack"},
        {STRING_FOR_PARAM_LOCAL_ENV_3_DECAY, "Env2 decay"},
        {STRING_FOR_PARAM_LOCAL_ENV_3_SUSTAIN, "Env2 sustain"},
        {STRING_FOR_PARAM_LOCAL_ENV_3_RELEASE, "Env2 release"},
