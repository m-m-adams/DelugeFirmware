...
menu_item::Submenu soundEditorRootMenu{
    STRING_FOR_SOUND,
    {
        &soundMasterMenu,   &arpMenu,         &audioCompMenu,
        &soundFiltersMenu,  &soundFXMenu,     &sidechainMenu,
        &source0Menu,       &source1Menu,     &modulator0Menu,
        &modulator1Menu,    &env0Menu,        &env1Menu,
        &env2Menu,          &env3Menu,        &lfo1Menu,
        &lfo2Menu,          &voiceMenu,       &bendMenu,
